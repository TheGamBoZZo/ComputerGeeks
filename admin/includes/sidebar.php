...
<aside
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "services.php"? 'active bg-gradient-primary':''; ?>" href="services.php">
          ...
          <span class="nav-link-text ms-1">All Services</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "add-services.php"? 'active bg-gradient-primary':''; ?>" href="add-services.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">add</i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "bookings.php"? 'active bg-gradient-primary':''; ?>" href="bookings.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">table_view</i>
          </div>
  ...
  <div class="mx-3">
      <a class="btn bg-gradient-primary mt-4 w-100" href="../index.php" type="button">
        Home page
      </a>
    </div>
    <div class="mx-3">
      <a class="btn bg-gradient-primary w-100" href="../logout.php" type="button">
        Logout
      </a>
    </div>
  </div>
